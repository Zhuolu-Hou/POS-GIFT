function [solution,rmse,cor1_new,cor2_new]=FSC(cor1,cor2,change_form,error_t,max_iteration_thead)
warning('off');
[M,N]=size(cor1);
...
if(max_iteration > max_iteration_thead)
    iterations = max_iteration_thead;
else
