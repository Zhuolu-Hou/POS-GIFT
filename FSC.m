function [solution,rmse,cor1_new,cor2_new]=FSC(cor1,cor2,change_form,error_t,max_iteration_thr)
warning('off');
[M,N]=size(cor1);
...
if(max_iteration > max_iteration_thr)
    iterations = max_iteration_thr;
else
